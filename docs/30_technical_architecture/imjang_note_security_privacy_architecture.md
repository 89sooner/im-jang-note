...
FR-SET-002, NFR-003에 따라 정보주체 권리를 구현한다. 동의 범위 세부는 ADR-006(accepted, 2026-06-01)에서 확정됐다: 목적별 개별 동의 + EXIF GPS 업로드 시점 제거 + 본인 작성 데이터 30일 grace 후 hard-delete + 탈퇴 시 코멘트 익명화.
